...
from train_utils_modified import batch_data_win, Reward, timeSince, plot_RL, multilabel_categorical_crossentropy
...
if __name__=="__main__":
    ...
    Reward_R1 = 2  # reward weight for interval consonance reward
    Reward_R2 = 2 # reward weight for chord progression reward
    Reward_R3 = 2  # new reward weight for voice leading
